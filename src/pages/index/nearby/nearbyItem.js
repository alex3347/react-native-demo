...
class NearbyItem extends React.Component {
    constructor(props){
        ...
        this.state = {
            ...
            price:'0.5',
            newUserStr:'新用户注册立送30元',
            oldUserStr:'每日登陆即送10元',
            payStr:'50送10 | 100送25 | 150送40 | 200送60 | 200送60 | 200送60 | 200送60 | 200送60'
        }
    }
            ...
            <View style={styles.container}>
                ...
                <View style={styles.market}>
                    <View style={styles.marketDescribe}>
                        ...
                        <View style={styles.marketActivity} class='nearby-market-activity-first'>
